    ...
    <>
      <div className="py-10  ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className="grid justify-center shadow-lg rounded-lg p-5 mx-2 mt-2 ">
          ...
          <div className="grid px-4 shadow-lg rounded-lg  mt-2">
            ...
            <span className="text-xs text-center text-red-500 hover:text-red-700">
